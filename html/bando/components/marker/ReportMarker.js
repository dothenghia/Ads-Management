...
export default function ReportMarker(map) {
    ...
    map.loadImage('/bando/assets/icon/baocao_TGSP.png', (error, image) => {
    ...
    map.loadImage('/bando/assets/icon/baocao_DKND.png', (error, image) => {
        if (error) throw error;
    ...
    map.loadImage('/bando/assets/icon/baocao_DGYK.png', (error, image) => {
        if (error) throw error;
    ...
    map.loadImage('/bando/assets/icon/baocao_GDTM.png', (error, image) => {
        if (error) throw error;
