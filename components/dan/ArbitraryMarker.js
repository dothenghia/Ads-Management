...
export default function ArbitraryMarker(type, map, longitude, latitude) {
    const mk = document.createElement('div');

    switch (type) {
        case 'tgsp':
            mk.className = 'marker marker-tgsp';
            ...
            break;
        case 'dknd':
            mk.className = 'marker marker-dknd';
            ...
            break;
        case 'dgyk':
            mk.className = 'marker marker-dgyk';
            ...
            break;
        case 'gdtm':
            mk.className = 'marker marker-gdtm';
