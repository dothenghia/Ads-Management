...
export default function ReportMarker(map, reportInfo) {
    ...
    switch (reportInfo.form) {
        case 'Tố giác sai phạm':
            mk.className = `marker marker-tgsp report-marker-${reportInfo.reportId}`;
            mk.innerHTML = `
        ...
        case 'Đăng ký nội dung':
            mk.className = `marker marker-dknd report-marker-${reportInfo.reportId}`;
            mk.innerHTML = `
            <div class="report-marker-popup-root report-marker-popup-root-${reportInfo.reportId}">${ReportPopup(reportInfo)}</div>
        ...
        case 'Đóng góp ý kiến':
            mk.className = `marker marker-dgyk report-marker-${reportInfo.reportId}`;
            mk.innerHTML = `
            <div class="report-marker-popup-root report-marker-popup-root-${reportInfo.reportId}">${ReportPopup(reportInfo)}</div>
        ...
        case 'Giải đáp thắc mắc':
            mk.className = `marker marker-gdtm report-marker-${reportInfo.reportId}`;
            mk.innerHTML = `
            <div class="report-marker-popup-root report-marker-popup-root-${reportInfo.reportId}">${ReportPopup(reportInfo)}</div>
