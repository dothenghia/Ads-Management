...
export default function ReportMarker(map, reportInfo) {
    ...
    switch (reportInfo.form) {
        case 'Tố giác sai phạm':
            mk.className = `marker marker-tgsp report-marker-${reportInfo.id}`;
        ...
        case 'Đăng ký nội dung':
            mk.className = `marker marker-dknd report-marker-${reportInfo.id}`;
        ...
        case 'Đóng góp ý kiến':
            mk.className = `marker marker-dgyk report-marker-${reportInfo.id}`;
